...
public class ChronoThoughtSpawner : MonoBehaviour
{
    public GameObject ChronoThoughtGood;
    public GameObject ChronoThoughtBad;
    ...
    void SpawnThoughts()
    {
        ...
        Instantiate(ChronoThoughtGood, spawnPosition, Quaternion.identity, SummonScreen);
    }
    void SpawnBadThoughts()
    {
        ...
        Vector2 spawnPosition = new Vector2(spawnX, spawnY);
        Instantiate(ChronoThoughtBad, spawnPosition, Quaternion.identity, SummonScreen);
    }
    void SpawnPortals()
    {
        ...
        bool DistanceCheck = MinDistance >= PortalDistance;
        while (DistanceCheck)
        {
